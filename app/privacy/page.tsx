      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl grow">
        ...
        <div className="space-y-8 text-lg text-gray-700 leading-relaxed">
          <section>
            ...
            <p>Welcome to Scriptdock Tech. We respect your privacy and are committed to protecting your personal data. This privacy policy informs you how we look after your personal data when you visit our website or use our software development services.</p>
          </section>
