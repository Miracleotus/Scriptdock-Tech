      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl grow">
        ...
        <div className="space-y-8 text-lg text-gray-700 leading-relaxed">
          <section>
            ...
            <p>Scriptdock Tech is a software and web development agency. We do not manufacture or ship physical products. All deliverables—including website access credentials, source code repositories (e.g., via GitHub/GitLab), design files, and applications—are delivered entirely digitally.</p>
          </section>
          ...
          <section>
            ...
            <p>For digital services purchased directly through our WooCommerce store (e.g., technical audits, consultation bookings), next steps, access instructions, or booking calendars will be delivered automatically to the email address provided at checkout within 24 hours of successful payment confirmation.</p>
          </section>
        </div>
      </main>
    </div>
